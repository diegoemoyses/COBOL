       ...
       01  WS-MSG-LEN             PIC S9(9) COMP VALUE 0.
       ...
       MAIN-PROCESS.
           ...
           IF WS-MSG-TEXT = SPACES
               DISPLAY '  MENSAGEM NAO IFORMADA NO SYSIN'
               MOVE 12 TO RETURN-CODE
               GOBACK
           END-IF.

           STRING FUNCTION CURRENT-DATE(1:16)
                  DELIMITED BY SIZE
                  INTO WS-JOB-INFO
           END-STRING.


           STRING WS-JOB-INFO DELIMITED BY SPACE
           ...
           ADD 16 TO WS-MSG-LENGTH

           DISPLAY ' MENSAGEM: ' WS-MSG-TEXT(1:WS-MSG-LENGTH)
           DISPLAY '  TAMANHO: ' WS-MSG-LENGTH
           DISPLAY '       ID: ' WS-JOB-INFO.
           DISPLAY ' '.
