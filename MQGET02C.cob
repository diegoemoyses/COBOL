       ...
       01 WS-HCONN             PIC S9(9) COMP VALUE -1.
       ...
       01  WS-TERM-MSG-LEN     PIC S9(9) COMP VALUE 0.
       ...
       MAIN-PROCESS.
           ...
           ELSE
               ...
               IF WS-COMP-CODE = MQCC-OK
                   ...
                   END-STRING
               ELSE
                   MOVE 'ERRO MQGET' TO WS-MSG-SAIDA
               END-IF
           ...
           MOVE  80 TO WS-TERM-MSG-LEN.

           EXEC CICS SEND
               ERASE
               FROM(WS-TERM-MSG)
               LENGTH(WS-TERM-MSG-LEN)
               NOHANDLE
           END-EXEC.
