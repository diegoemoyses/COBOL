      ...
      *    1. CONECTAR
           ...
           DISPLAY 'CONECTADO COM SUCESSO!'.

      *    2. ABRIR FILA PARA LEITURA
           INITIALIZE MQOD.
           ...
           DISPLAY 'FILA ABERTA COM SUCESSO!'.

      *    3. PREPARAR ESTRUTURAS PARA GET
           INITIALIZE MQMD.
      ...
      *    4. LER MENSAGEM DA FILA
           ...
           IF WS-COMP-CODE = MQCC-OK
               ...
               DISPLAY 'TAMANHO RECEBIDO: ' WS-MSG-DATA-LEN
               DISPLAY 'MENSAGEM: ' WS-MSG-TEXT(1:WS-MSG-DATA-LEN)
           ELSE
